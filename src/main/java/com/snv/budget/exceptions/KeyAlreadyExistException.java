...
public class KeyAlreadyExistException extends Exception {
    ...
    public KeyAlreadyExistException(final String message) {
        super(message);
    }

    public KeyAlreadyExistException(final String message, final Throwable t) {
        super(message, t);
    }

    public KeyAlreadyExistException(final Throwable t) {
        super(t);
    }
}
