...
public enum DataBaseNamesEnum {
    BUDGETS, CATEGORIES, COMPTES, ECHEANCIERS, MODEDEPAIEMENT, MOUVEMENTS, 
    MOUVEMENTSECHEANCIER, PARAMETERS, TYPEDECOMPTES, TYPEDEMOUVEMENT,
    TYPEECHEANCIER, USERS, TODOS, CALENDARS, ACCOUNTS
}
