...
public class BudgetDataBaseException extends DatabaseException {
    ...
    public BudgetDataBaseException(final String message) {
        super(message);
    }

    public BudgetDataBaseException(final String message, final Throwable t) {
        super(message, t);
    }

    public BudgetDataBaseException(final Throwable t) {
        super(t);
    }
}
