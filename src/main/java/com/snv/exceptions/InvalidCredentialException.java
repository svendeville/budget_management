...
public class InvalidCredentialException extends DatabaseException {
    ...
    public InvalidCredentialException(final String message, final Throwable t) {
        super(message, t);
    }

    public InvalidCredentialException(final Throwable t) {
        super(t);
    }
}
